# Enlistment Paste Assist
An AutoHotkey V2 script that assists with the enlistment at Placeholder University in their Placeholder Site.

## Usage:
1. Download and Install [AutoHotkey V2](https://www.autohotkey.com/v2/)
2. Create a .txt file containing your courses to be enlisted separated by line, e.g.:
```
CMPROG3
DISCTRU
SALDGCC
